#ifndef TauCleaning_PATtupleProduction_QjetsAdder_h
#define TauCleaning_PATtupleProduction_QjetsAdder_h
...
#include "TauCleaning/PATtupleProduction/interface/QjetsPlugin.h"
