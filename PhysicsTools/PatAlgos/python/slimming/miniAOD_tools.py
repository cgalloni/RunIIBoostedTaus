...
def miniAOD_customizeCommon(process):
 ...
 ######Start: Boosted Semileptonic taus######
    ...
    massSearchReplaceAnyInputTag(process.PATTauSequenceMuTau,cms.InputTag("ak4PFJets"),cms.InputTag("ak4PFJetsNoMu"))
    process.slimmedTausMuTau = process.slimmedTaus.clone(src = cms.InputTag("selectedPatTausMuTau"))
 ######Start: Boosted Semileptonic taus######
   # process.ptau = cms.Path( process.PFTau )
    #process.PATTauSequence = cms.Sequence(process.PFTau+process.makePatTaus+process.selectedPatTaus)
    process.PATTauSequenceEleTau = cloneProcessingSnippet(process,process.PATTauSequence, "EleTau")
    massSearchReplaceAnyInputTag(process.PATTauSequenceEleTau,cms.InputTag("ak4PFJets"),cms.InputTag("ak4PFJetsNoEle"))
    process.slimmedTausEleTau = process.slimmedTaus.clone(src = cms.InputTag("selectedPatTausEleTau"))



######End: Boosted Semileptonic taus  
